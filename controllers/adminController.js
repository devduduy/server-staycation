...
module.exports = {
  ...
  actionLogout: (req, res) => {
    req.session.destroy();
    // req.flash("alertMessage", "Logged out successfully");
  ...
  addItem: async (req, res) => {
    try {
      const { categoryId, title, price, city, descriptionItem } = req.body;
  ...
  actionConfirmation: async (req, res) => {
    ...
    try {
      ...
      await booking.save();
      req.flash("alertMessage", "Success confirmation of payment");
      req.flash("alertStatus", "success");
      res.redirect(`/admin/booking`);
    } catch (error) {
      res.redirect(`/admin/booking`);
  ...
  actionReject: async (req, res) => {
    ...
    try {
      ...
      await booking.save();
      req.flash("alertMessage", "Success reject of payment");
      req.flash("alertStatus", "success");
      res.redirect(`/admin/booking`);
    } catch (error) {
      res.redirect(`/admin/booking`);
